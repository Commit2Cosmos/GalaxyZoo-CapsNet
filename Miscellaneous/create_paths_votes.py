...
merged = pd.read_csv('./InitData/Kaggle/labels_train.csv', usecols=[0,1,2,3,4,5,6,7])
...
merged['GalaxyID'] = merged.iloc[:200,0].map(lambda x:f'{x}.jpg')
...
#* save csv
merged.to_csv('./PreparedData/Kaggle/paths_votes_test.csv', encoding='utf-8', index=False)